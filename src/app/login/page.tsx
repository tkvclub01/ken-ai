    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-muted-foreground">Intelligent Student Management Platform</p>
        </div>
                ...
                <form className="space-y-4" onSubmit={handlePasswordSignIn}>
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="email-password" name="email" type="email" autoComplete="email" required className="pl-10" placeholder="you@example.com" />
                    </div>
                  </div>
                  <div className="space-y-2">
                ...
                {magicLinkSent ? (
                  ...
                  <form onSubmit={handleMagicLink} className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Mail className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                        <Input id="email-magic" name="email" type="email" autoComplete="email" required className="pl-10" placeholder="you@example.com" />
                      </div>
                    </div>
                    <Button type="submit" className="w-full" disabled={loading}>
